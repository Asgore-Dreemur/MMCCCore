...
namespace MMCCCore.Module.GameAssemblies
{
    public class Fabric : InstallerModel
    {
        ...
        public InstallerReponse InstallFabric(string GameDir, string VersionName, FabricVersionModel InstallInfo, string VanillaVersionName, int MaxThreadCount = 64)
        {
            try
            {
